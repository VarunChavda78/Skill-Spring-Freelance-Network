...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ['id', 'title', 'description', 'budget', 'client','department']
...
class ProposalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Proposal
        fields = ['id', 'project', 'freelancer', 'bid_amount', 'description','approval']
...
class CreateProposalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Proposal
        fields = ['id', 'project', 'freelancer', 'bid_amount', 'description']
...
class UserregisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['username', 'email','is_freelancer','is_client','password', 'password2']
        extra_kwargs = {
