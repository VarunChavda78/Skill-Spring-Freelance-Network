...
const Web_developement = ({ isAuthenticated, handleLogout }) => {
    ...
    <div className="App">
      ...
      <main className="main-content">
        <section className="intro">
          <h1>Find Your Next Web Development Project</h1>
          <p>
          The web development project focuses on creating a dynamic and responsive website for a freelance platform called "Skill Spring Freelance." The platform connects clients with talented freelancers across various fields. Using React for the frontend and Django for the backend, the project incorporates user authentication, project management features, and a user-friendly interface, ensuring an efficient and seamless experience for all users.
          </p>
        ...
        <section className="featured-projects">
          ...
          <div className="projects-list">
            {projects.length > 0 ? (
              projects
              .filter(project => project.department === 'Web_development')
              .map((project) => (
...
export default Web_developement;
