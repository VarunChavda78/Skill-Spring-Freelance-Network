...
const Cloud_computing = ({ isAuthenticated, handleLogout }) => {
    ...
    <div className="App">
      ...
      <main className="main-content">
        <section className="intro">
          <h1>Find Your Next Cloud Computing Project</h1>
          <p>
          The Cloud Computing Project aims to develop a scalable and efficient cloud-based infrastructure that allows users to store, manage, and access data seamlessly over the internet. Leveraging virtualization technologies, the project provides on-demand resources, ensuring flexibility and cost-effectiveness. Key features include data security, automated backups, and collaborative tools, empowering users to enhance productivity and streamline operations from anywhere.
          </p>
        ...
        <section className="featured-projects">
          ...
          <div className="projects-list">
            {projects.length > 0 ? (
              projects
              .filter(project => project.department === 'Cloud_computing')
              .map((project) => (
