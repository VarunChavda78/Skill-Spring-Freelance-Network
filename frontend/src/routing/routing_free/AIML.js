...
const AIML = ({ isAuthenticated, handleLogout }) => {
    ...
    <div className="App">
      ...
      <main className="main-content">
        <section className="intro">
          <h1>Find Your Next AIML Project</h1>
          <p>
          The AIML (Artificial Intelligence Markup Language) project focuses on creating intelligent chatbots that can engage in natural language conversations. By leveraging AIML, the project enables the development of responsive, context-aware virtual assistants capable of understanding user queries and providing relevant responses. It aims to enhance user experience in customer service, education, and entertainment through effective conversational interfaces.
          </p>
        </section>
        ...
        <section className="featured-projects">
          ...
          <div className="projects-list">
            {projects.length > 0 ? (
              projects
              .filter(project => project.department === 'AIML')
              .map((project) => (
