...
const Game_development = ({ isAuthenticated, handleLogout }) => {
    ...
    <div className="App">
      ...
      <main className="main-content">
        <section className="intro">
          <h1>Find Your Next Game Development Project</h1>
          <p>
          The game development project aims to create an immersive 2D platformer where players navigate vibrant environments, solve puzzles, and defeat enemies. Utilizing Unity and C#, the game features engaging mechanics, customizable characters, and a captivating storyline. Collaborating in an agile team, we focus on user experience, art design, and performance optimization to deliver a polished final product that appeals to gamers of all ages.
          </p>
        ...
        <section className="featured-projects">
          ...
          <div className="projects-list">
            {projects.length > 0 ? (
              projects
              .filter(project => project.department === 'Game_development')
              .map((project) => (
...
export default Game_development;
